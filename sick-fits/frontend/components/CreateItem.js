...
import fotmatMoney from '../lib/formatMoney';
...
class CreateItem extends React.Component {
    ...
    uploadFile = async e => {
        ...
        const res = await fetch('https://api.cloudinary.com/v1_1/dzimmpuvy/image/upload', {
            method: 'POST',
            body: data
        });
                ...
                {(createItem, { loading, error }) => (
                    <Form onSubmit={async e => {
                        ...
                        <fieldset disabled={loading} aria-busy={loading} >
                            <label htmlFor="file">
                                Image
                                <input type="file" id="dile" name="dile" placeholder="Upload an image" required onChange={this.uploadFile} />
